...
function UpdateJob() {
  ...
  function CheckInputs()  {
    ...
    if (!document.querySelector("input[name=pera]:checked")){field="PERA"};
    if (!document.querySelector("input[name=internet]:checked")){field="internet"};
    if (!document.querySelector("input[name=cellphone]:checked")){field="phone"};
  ...
  function putValue (myString, amt) {
    ...
    sessionStorage.setItem(myString, div.textContent );
    console.log(sessionStorage.getItem(myString));
  }
