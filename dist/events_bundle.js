...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _events_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./events.css */ \"./src/events.css\");\n\r\n\r\n\r\nlet mydata = [];\r\n\r\nconst day = document.getElementById(\"day\");\r\nconst desc = document.getElementById(\"description\");\r\nconst hrs = document.getElementById(\"hr\");\r\nconst mins = document.getElementById(\"min\");\r\nconst miles = document.getElementById(\"bmiles\");\r\nconst misc = document.getElementById(\"bmisc\");\r\n\r\nfunction clearInputs () {\r\n  day.value = \"\";\r\n  desc.value = \"\";\r\n  hrs.value = 0;\r\n  mins.value = 0;\r\n  miles.value = \"\";\r\n  misc.value = \"\"\r\n}\r\nfunction saveInputs()  {\r\n  let myarray = [];\r\n\r\n  const amount = getAmountDiv();\r\n   \r\n  myarray[0] = day.value;\r\n  myarray[1] = desc.value;\r\n  if (!eventtype.omtgs) {\r\n    myarray[2] = amount;\r\n  }\r\n  mydata.push(myarray);\r\n}\r\nfunction assignData () {\r\n  if (eventtype.hours) {\r\n    datatables.hours.data = mydata;\r\n    userinputs.hours = calculateTotals(mydata);\r\n  }\r\n  else if (eventtype.miles) {\r\n    datatables.miles.data = mydata;\r\n    userinputs.miles = calculateTotals(mydata);\r\n  }\r\n  else if (eventtype.misc) {\r\n    datatables.misc.data = mydata;\r\n    userinputs.misc = calculateTotals(mydata);\r\n  }\r\n  else if (eventtype.omtgs) {\r\n    datatables.omtgs.data = mydata;\r\n    userinputs.omtgs = calculateTotals(mydata);\r\n    userinputs.mtgs = userinputs.omtgs + userinputs.bmtgs;\r\n  }\r\n}\r\nfunction calculateHours() {\r\n  return Number((hrs.value + mins.value).toFixed(2));\r\n}\r\nfunction calculateTotals(array) {\r\n  let total = 0;\r\n  if (array.length > 2) {\r\n    for (let i=0; i < array.length; i++) {\r\n      total = total + Number(array[2]);\r\n    }\r\n  }\r\n  else {\r\n    total = array.length;\r\n  }\r\n  return total;\r\n}\r\nfunction getAmountDiv() {\r\n  let amount = 0;\r\n  if (eventtype.hours) {\r\n    amount = calculateHours();\r\n  }\r\n  else if (eventtype.miles) {\r\n    amount = Number(miles.toFixed(2));\r\n  }\r\n  else if (eventtype.misc) {\r\n    amount = Number(misc.toFixed(2));\r\n  }\r\n  return amount;\r\n}\r\n\n\n//# sourceURL=webpack://payrollcalculator/./src/events.js?");
