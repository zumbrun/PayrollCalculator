...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _events_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./events.css */ \"./src/events.css\");\n/* harmony import */ var _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./globalobjects.js */ \"./src/globalobjects.js\");\n\r\n\r\n\r\nlet myeventarray = [];\r\nconsole.log((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"hours\"));\r\n// set up view\r\nif ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"hours\")) {\r\n  console.log(\"display hours\");\r\n  let div = document.getElementById('bottomhours');\r\n  div.style.display = \"block\";\r\n}\r\nelse if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"miles\")) {SetBottom(\"miles\")}\r\nelse if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"misc\")) {SetBottom(\"misc\")}\r\n// assign button actions\r\nconst doneButton = document.getElementById('doneButton');\r\nconst addButton = document.getElementById('addButton');\r\nconst cancelButton = document.getElementById('cancelButton');\r\n\r\nif (doneButton) {doneButton.addEventListener('click', Done);}\r\nif (cancelButton) {cancelButton.addEventListener('click', Cancel)};\r\nif (addButton) {addButton.addEventListener('click', AddEntry)};\r\n\r\nfunction SetBottom(str) {   \r\n  let input = document.createElement(\"input\");\r\n  input.type = \"number\";\r\n  input.value = \"\";\r\n  input.id = \"bottomip\";\r\n  let lbl = document.createElement('label');\r\n  lbl.innerHTML = \"Enter \" + str + \" :\";\r\n  lbl.setAttribute(\"for\", \"bottomip\");\r\n  const div = document.getElementById('bottomamount');\r\n  div.appendChild(lbl);\r\n  div.appendChild(input);\r\n  div.style.display = \"block\" \r\n}\r\n  //return from events to outputs\r\nfunction Cancel() {\r\n  window.location.href = \"index.html\";\r\n}\r\n// save data and return\r\nfunction Done () {\r\n  SaveInputs();\r\n  StoreInputs(myeventarray);\r\n  let total = CalculateTotals(myeventarray);\r\n  if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"hours\")) {_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.userinputs.hours = Number(total.toFixed(2))};\r\n  if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"miles\")) {_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.userinputs.miles = Number(total.toFixed(2))};\r\n  if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"misc\")) {_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.userinputs.misc = Number(total.toFixed(2))};\r\n  if ((0,_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.getShowdiv)(\"omtgs\")) {_globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.userinputs.omtgs = total};\r\n  \r\n  /* if (localStorage(\"displayHours\") === \"block\") {\r\n    userinputs.hours = Number(total.toFixed(2));\r\n  }\r\n  else if (localStorage(\"displayMiles\") === \"block\") {\r\n    userinputs.miles = Number(total.toFixed(2));\r\n  }\r\n  else if (localStorage(\"displayMisc\") === \"block\") {\r\n    userinputs.misc = Number(total.toFixed(2));\r\n  }\r\n  else {\r\n    userinputs.omtgs = myeventarray.length;\r\n  } */\r\n  Cancel();\r\n}\r\n// save data\r\nfunction SaveInputs()  {\r\n  let myarray = [];\r\n  myarray[0] = document.getElementById(\"day\").value;\r\n  myarray[1] = document.getElementById(\"description\").value;\r\n  if (showdiv.hours) {myarray[2] = CalculateHours();}\r\n  else {\r\n    const element = document.getElementById(\"bottomip\");\r\n    if (element) {myarray[2] = Number(element.value.toFixed(2))};\r\n  }\r\n  myeventarray.push(myarray);\r\n  console.log(myeventarray);\r\n  return;\r\n}\r\nfunction StoreInputs(array) {\r\n    if (showdiv.hours) {\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.hours.exist = true;\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.hours.data = array;\r\n    }\r\n    else if (showdiv.miles) {\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.miles.exist = true;\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.miles.data = array;\r\n    }\r\n    else if (showdiv.misc) {\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.misc.exist = true;\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.misc.data = array;\r\n    }\r\n    else if (showdiv.omtgs) {\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.omtgs.exist = true;\r\n      _globalobjects_js__WEBPACK_IMPORTED_MODULE_1__.datatables.omtgs.data = array;\r\n    }\r\n    /* for (let i = 0; i < array.length; i++) {\r\n      const myjson = JSON.stringify(array[i]);\r\n      console.log({myjson});\r\n      localStorage.setItem(\"mydata\" + i, myjson);\r\n    }; */\r\n}\r\nfunction AddEntry() {\r\n  SaveInputs();\r\n  // clear inputs for next entry\r\n  document.getElementById(\"day\").value = \"\";\r\n  document.getElementById(\"description\").value = \"\";\r\n  if (showdiv.hours) {\r\n    document.getElementById(\"hr\").value = 0;\r\n    document.getElementById(\"min\").value = 0;}\r\n  else {\r\n    let div = document.getElementById('bottomip');\r\n    if (div) {div.value = \"\"};\r\n  }\r\n}\r\nfunction CalculateTotals(array) {\r\n  let total = 0;\r\n  for (let i=0; i<array.length; i++) {\r\n    total = total + Number(array[2]);\r\n  }\r\n  return total;\r\n}\r\nfunction CalculateHours() {\r\n  const hrs = Number(document.getElementById(\"hr\").value);\r\n  const mins = Number(document.getElementById(\"min\").value);\r\n  return Number((hrs + mins).toFixed(2));\r\n}\r\n\r\n\r\n\n\n//# sourceURL=webpack://payrollcalculator/./src/events.js?");

/***/ }),

/***/ "./src/globalobjects.js":
/*!******************************!*\
  !*** ./src/globalobjects.js ***!
  \******************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   datatables: () => (/* binding */ datatables),\n/* harmony export */   getShowdiv: () => (/* binding */ getShowdiv),\n/* harmony export */   setDatatables: () => (/* binding */ setDatatables),\n/* harmony export */   setShowdiv: () => (/* binding */ setShowdiv),\n/* harmony export */   setUserinputs: () => (/* binding */ setUserinputs),\n/* harmony export */   showdiv: () => (/* binding */ showdiv),\n/* harmony export */   userinputs: () => (/* binding */ userinputs)\n/* harmony export */ });\nlet userinputs = {\n    name: \"-\",\n    title: \"-\",\n    hours: 0,\n    bmtgs: 0,\n    omtgs: 0,\n    mtgs: 0,\n    pera: 0,\n    phone: 0,\n    internet: 0,\n    miles: 0,\n    misc:0,\n }\n let showdiv = {\n   hours: false,\n   miles: false,\n   misc: false,\n   omtgs: false,\n }\n let datatables = {\n   hours: { data: []},\n   miles: { data: []},\n   misc:  { data: []},\n   omtgs: { data: []},\n }\n function setShowdiv(mykey, myvalue) {\n    console.log ({mykey}, {myvalue});\n    Object.keys(showdiv).forEach((item) => {\n      if (item === mykey) {\n        showdiv[item] = myvalue;\n        console.log(showdiv[item]);\n      }\n    });\n }\n function getShowdiv(mykey){\n  Object.keys(showdiv).forEach((item) => {\n    if (item === mykey) {\n      console.log({item});\n      console.log(showdiv[item]);\n      return showdiv[item];\n    }\n  });\n }\n function setUserinputs(mykey, myvalue) {\n  for (const[key, value] of Object.entries(userinputs)) {\n    if (key === mykey) {\n      value = myvalue\n    }\n  };\n}\nfunction setDatatables(mykey, myvalue) {\n  for (const[key, value] of Object.entries(userinputs)) {\n    if (key === mykey) {\n      value = myvalue\n    }\n  };\n}\n\n\n//# sourceURL=webpack://payrollcalculator/./src/globalobjects.js?");
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/events.js");
/******/ 	
/******/ })()
;